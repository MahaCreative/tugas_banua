...
export default function Navbar() {
  return (
      <div className='fixed top-0 left-0 w-full min-h-5 z-10 bg-slate-950/30 backdrop-blur-sm flex justify-between items-center border-b border-slate-100/20 border-dashed'>
